# Awesome Create React App with stars
...
* [Create React App GitHub](https://github.com/facebookincubator/create-react-app) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
* [User Guide](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
...
* [Craft Template - MobX + React Router](https://github.com/timarney/cra-mobx-reactrouter) ⭐ 12 | 🐛 0 | 🌐 JavaScript | 📅 2017-02-17 - CRA Template with Mobx and Router

## Deployment

* [Create React App Buildpack](https://github.com/mars/create-react-app-buildpack) ⚠️ Archived
* [Creare React App - now.sh](https://github.com/xkawi/create-react-app-now) ⚠️ Archived
...
* [How You Can Use React-Toolbox With Create-React-App](https://github.com/react-toolbox/react-toolbox-themr) ⭐ 238 | 🐛 30 | 🌐 JavaScript | 📅 2018-02-20
...
This is not documented yet. More info at [Maintaining a fork of react-scripts as an alternative to ejecting #682](https://github.com/facebookincubator/create-react-app/issues/682) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
...
* [React Scripts (Isomorphic)](https://github.com/firstlookmedia/react-scripts) ⭐ 215 | 🐛 10 | 🌐 JavaScript | 📅 2023-01-27 - Provides configuration for FLM's isomorphic React apps.
* [React Super Scripts](https://github.com/shrynx/react-super-scripts) ⚠️ Archived - Adds super powers to create-react-app and allows custom configs without ejecting.
* [React Scripts Web](https://github.com/raymondsze/create-react-scripts/tree/master/packages/react-scripts-web) ⭐ 63 | 🐛 7 | 🌐 JavaScript | 📅 2019-01-06 - React-scripts built using create-react-scripts, supports workbox(PWA), vendorDll, babelrc and eslintrc.
* [Create React App Sass](https://github.com/rickharrison/create-react-app-sass) ⭐ 41 | 🐛 2 | 📅 2017-03-04 - Enhances create-react-app to include support for Sass.
* [React Scripts With SSR](https://github.com/joernb/react-scripts-with-ssr) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2019-02-19 - Adds server-side rendering to create-react-app projects.
* [Custom React Scripts](https://www.npmjs.com/package/custom-react-scripts) - Configuration and scripts for Create React App.

## Alternatives

* [React App Rewired](https://github.com/timarney/react-app-rewired) ⭐ 9,839 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-13 - Configure the unconfigurable, override create-react-app webpack configs.
...
Alternatives from [Create React App README](https://github.com/facebookincubator/create-react-app#alternatives) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15:

* [zeit/next.js](https://github.com/zeit/next.js) ⭐ 142,478 | 🐛 3,493 | 🌐 JavaScript | 📅 2026-09-26 - Framework for server-rendered React apps.
* [gatsbyjs/gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 451 | 🌐 JavaScript | 📅 2026-09-25 - Transform plain text into dynamic blogs and websites using React.
...
* [enclave](https://github.com/eanplatter/enclave) ⚠️ Archived - A simpler way to compile React applications.
...
* [aik](https://github.com/d4rkr00t/aik) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2018-03-06- Frontend Playground.

## FAQ

### How to Use Env Config

* [Adding Custom Environment Variables](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#adding-custom-environment-variables) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
...
* [Adding Development Environment Variables In `.env`](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#adding-development-environment-variables-in-env) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15

> To define permanent environment variables, create a file called .env in the root of your project

### How to Use Multiple Env Configs

Right now it is possible installing [dotenv](https://github.com/motdotla/dotenv) ⭐ 20,544 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 and updating npm scripts:
...
There is the Pull Request [#1344](https://github.com/facebookincubator/create-react-app/pull/1344) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 that implements [Support different env configs](https://github.com/facebookincubator/create-react-app/issues/1343) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15:
...
These are environment variables. Use [cross-env](https://github.com/kentcdodds/cross-env) ⚠️ Archived to set environment variables across platforms or *.env* config.
...
Original issue - [Lazy load (chunking) feature? #925](https://github.com/facebookincubator/create-react-app/issues/925) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
...
Official solution: create `node_modules` at `src` directory - [src/node\_modules as official solution for absolute imports #1065](https://github.com/facebookincubator/create-react-app/issues/1065) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15
...
Create React App [doesn’t support decorator syntax](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#can-i-use-decorators) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 at the moment.

There are PR [Adding support for custom babel configuration #1357](https://github.com/facebookincubator/create-react-app/pull/1357) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15. If PR is merged then these features will be available:
...
[@dan\_abramov](https://twitter.com/dan_abramov) wrote:
...
So we do not recommend to use babel presets besides the [babel-preset-react-app](https://github.com/facebookincubator/create-react-app/tree/master/packages/babel-preset-react-app) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 that is already configured at Create React App.

### How to Change Webpack Entry Point and Output Dir?

There is the issue - [Customize build folder #1354](https://github.com/facebookincubator/create-react-app/issues/1354) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15.
This is feature is very useful along with entry point customizing and I have left  [comment](https://github.com/facebookincubator/create-react-app/issues/1354#issuecomment-275647959) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 about this.

But according to this Pull Request [Fix- react-scripts build doesn't allow for specified path #1362](https://github.com/facebookincubator/create-react-app/pull/1362#issuecomment-271284738) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 we should not expect such customizations in near future.
